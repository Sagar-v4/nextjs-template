...
export const metadata: Metadata = {
	...
	icons: {
		icon: [
			{ url: 'assets/favicon-196.png', sizes: '196x196', type: 'image/png' },
		],
	...
	appleWebApp: {
		...
		startupImage: [
			...
			{
				url: 'assets/apple-splash-1320-2868.jpg',
				media:
					'(device-width: 440px) and (device-height: 956px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)',
			},
			{
				url: 'assets/apple-splash-2868-1320.jpg',
				media:
					'(device-width: 440px) and (device-height: 956px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)',
			},
			{
				url: 'assets/apple-splash-1206-2622.jpg',
				media:
					'(device-width: 402px) and (device-height: 874px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)',
			},
			{
				url: 'assets/apple-splash-2622-1206.jpg',
				media:
